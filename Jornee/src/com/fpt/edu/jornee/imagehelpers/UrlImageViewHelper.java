 ...
 * FileName: UrlImageViewHelper.java
...
//        Log.v(Constants.LOGTAG,targetHeight);
     ...
     * @param url The URL of the image that should be loaded.
     */
    public static void setUrlDrawable(final ImageView imageView, String url) {
    	if(!url.startsWith("http") && !url.startsWith("file://")){
    		url.replaceAll("\\s+", "%20");
    		url = "file://"+url;
    	}
        setUrlDrawable(imageView.getContext(), imageView, url, null, CACHE_DURATION_INFINITE, null);
    }

    public static void loadUrlDrawable(final Context context, String url) {
    	if(!url.startsWith("http") && !url.startsWith("file://")){
    		url.replaceAll("\\s+", "%20");
    		url = "file://"+url;
    	}
        setUrlDrawable(context, null, url, null, CACHE_DURATION_INFINITE, null);
    }
    ...
    public static void setUrlDrawable(final ImageView imageView, final String url, final Drawable defaultDrawable) {
        setUrlDrawable(imageView.getContext(), imageView, url, defaultDrawable, CACHE_DURATION_INFINITE, null);
    }
    ...
    public static void setUrlDrawable(final ImageView imageView, final String url, final int defaultResource, final UrlImageViewCallback callback) {
        setUrlDrawable(imageView.getContext(), imageView, url, defaultResource, CACHE_DURATION_INFINITE, callback);
    }
    ...
    public static void setUrlDrawable(final ImageView imageView, final String url, final UrlImageViewCallback callback) {
        setUrlDrawable(imageView.getContext(), imageView, url, null, CACHE_DURATION_INFINITE, callback);
    }

    public static void loadUrlDrawable(final Context context, final String url, final UrlImageViewCallback callback) {
        setUrlDrawable(context, null, url, null, CACHE_DURATION_INFINITE, callback);
    }
    ...
    public static void setUrlDrawable(final ImageView imageView, final String url, final Drawable defaultDrawable, final UrlImageViewCallback callback) {
        setUrlDrawable(imageView.getContext(), imageView, url, defaultDrawable, CACHE_DURATION_INFINITE, callback);
    }
